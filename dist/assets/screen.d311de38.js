...
`,[c("slides",`
 ...
 `)])])]),fn=["transitionDuration","transitionTimingFunction"],vn=Object.assign(Object.assign({},et.props),{defaultIndex:{type:Number,default:0},currentIndex:Number,showArrow:Boolean,dotType:{type:String,default:"dot"},dotPlacement:{type:String,default:"bottom"},slidesPerView:{type:[Number,String],default:1},spaceBetween:{type:Number,default:0},centeredSlides:Boolean,direction:{type:String,default:"horizontal"},autoplay:Boolean,interval:{type:Number,default:5e3},loop:{type:Boolean,default:!0},effect:{type:String,default:"slide"},showDots:{type:Boolean,default:!0},trigger:{type:String,default:"click"},transitionStyle:{type:Object,default:()=>({transitionDuration:"300ms"})},transitionProps:Object,draggable:Boolean,prevSlideStyle:[Object,String],nextSlideStyle:[Object,String],touchable:{type:Boolean,default:!0},mousewheel:Boolean,keyboard:Boolean,"onUpdate:currentIndex":Function,onUpdateCurrentIndex:Function});let Ie=!1;const hn=J({name:"Carousel",props:vn,setup(e){const{mergedClsPrefixRef:a,inlineThemeDisabled:o}=fe(e),r=I(null),v=I(null),m=I([]),x={value:[]},S=h(()=>e.direction==="vertical"),C=h(()=>S.value?"height":"width"),p=h(()=>S.value?"bottom":"right"),f=h(()=>e.effect==="slide"),b=h(()=>e.loop&&e.slidesPerView===1&&f.value),R=h(()=>e.effect==="custom"),B=h(()=>!f.value||e.centeredSlides?1:e.slidesPerView),F=h(()=>R.value?1:e.slidesPerView),_=h(()=>B.value==="auto"||e.slidesPerView==="auto"&&e.centeredSlides),P=I({width:0,height:0}),z=h(()=>{const{value:t}=m;if(!t.length)return[];const{value:n}=_;if(n)return t.map(w=>qe(w));const{value:s}=F,{value:i}=P,{value:u}=C;let l=i[u];if(s!=="auto"){const{spaceBetween:w}=e,k=l-(s-1)*w,ie=1/Math.max(1,s);l=k*ie}const g=Object.assign(Object.assign({},i),{[u]:l});return t.map(()=>g)}),$=h(()=>{const{value:t}=z;if(!t.length)return[];const{centeredSlides:n,spaceBetween:s}=e,{value:i}=C,{[i]:u}=P.value;let l=0;return t.map(({[i]:g})=>{let w=l;return n&&(w+=(g-u)/2),l+=g+s,w})}),K=I(!1),he=h(()=>{const{transitionStyle:t}=e;return t?je(t,fn):{}}),pe=h(()=>R.value?0:tn(he.value.transitionDuration)),Ee=h(()=>{const{value:t}=m;if(!t.length)return[];const n=!(_.value||F.value===1),s=g=>{if(n){const{value:w}=C;return{[w]:`${z.value[g][w]}px`}}};if(R.value)return t.map((g,w)=>s(w));const{effect:i,spaceBetween:u}=e,{value:l}=p;return t.reduce((g,w,k)=>{const ie=Object.assign(Object.assign({},s(k)),{[`margin-${l}`]:`${u}px`});return g.push(ie),K.value&&(i==="fade"||i==="card")&&Object.assign(ie,he.value),g},[])}),D=h(()=>{const{value:t}=B,{length:n}=m.value;if(t!=="auto")return Math.max(n-t,0)+1;{const{value:s}=z,{length:i}=s;if(!i)return n;const{value:u}=$,{value:l}=C,g=P.value[l];let w=s[s.length-1][l],k=i;for(;k>1&&w<g;)k--,w+=u[k]-u[k-1];return ce(k+1,1,i)}}),Q=h(()=>en(D.value,b.value)),ot=ke(e.defaultIndex,b.value),ge=I(We(ot,D.value,b.value)),E=At(Bt(e,"currentIndex"),ge),N=h(()=>ke(E.value,b.value));function Y(t){var n,s;t=ce(t,0,D.value-1);const i=We(t,D.value,b.value),{value:u}=E;i!==E.value&&(ge.value=i,(n=e["onUpdate:currentIndex"])===null||n===void 0||n.call(e,i,u),(s=e.onUpdateCurrentIndex)===null||s===void 0||s.call(e,i,u))}function ee(t=N.value){return Jt(t,D.value,e.loop)}function te(t=N.value){return Qt(t,D.value,e.loop)}function at(t){const n=j(t);return n!==null&&ee()===n}function st(t){const n=j(t);return n!==null&&te()===n}function Ne(t){return N.value===j(t)}function lt(t){return E.value===t}function Ve(){return ee()===null}function Te(){return te()===null}function xe(t){const n=ce(ke(t,b.value),0,D.value);(t!==E.value||n!==N.value)&&Y(n)}function me(){const t=ee();t!==null&&Y(t)}function ne(){const t=te();t!==null&&Y(t)}function rt(){(!V||!b.value)&&me()}function it(){(!V||!b.value)&&ne()}let V=!1,M=0;const we=I({});function oe(t,n=0){we.value=Object.assign({},he.value,{transform:S.value?`translateY(${-t}px)`:`translateX(${-t}px)`,transitionDuration:`${n}ms`})}function U(t=0){f.value?be(N.value,t):M!==0&&(!V&&t>0&&(V=!0),oe(M=0,t))}function be(t,n){const s=$e(t);s!==M&&n>0&&(V=!0),M=$e(N.value),oe(s,n)}function $e(t){let n;return t>=D.value-1?n=Ae():n=$.value[t]||0,n}function Ae(){if(B.value==="auto"){const{value:t}=C,{[t]:n}=P.value,{value:s}=$,i=s[s.length-1];let u;if(i===void 0)u=n;else{const{value:l}=z;u=i+l[l.length-1][t]}return u-n}else{const{value:t}=$;return t[D.value-1]||0}}const H={currentIndexRef:E,to:xe,prev:rt,next:it,isVertical:()=>S.value,isHorizontal:()=>!S.value,isPrev:at,isNext:st,isActive:Ne,isPrevDisabled:Ve,isNextDisabled:Te,getSlideIndex:j,getSlideStyle:dt,addSlide:ut,removeSlide:ct,onCarouselItemClick:ft};nn(H);function ut(t){!t||m.value.push(t)}function ct(t){if(!t)return;const n=j(t);n!==-1&&m.value.splice(n,1)}function j(t){return typeof t=="number"?t:t?m.value.indexOf(t):-1}function dt(t){const n=j(t);if(n!==-1){const s=[Ee.value[n]],i=H.isPrev(n),u=H.isNext(n);return i&&s.push(e.prevSlideStyle||""),u&&s.push(e.nextSlideStyle||""),tt(s)}}function ft(t,n){let s=!V&&!le&&!_e;e.effect==="card"&&s&&!Ne(t)&&(xe(t),s=!1),s||(n.preventDefault(),n.stopPropagation())}let ae=null;function se(){ae&&(clearInterval(ae),ae=null)}function O(){se(),!e.autoplay||Q.value<2||(ae=window.setInterval(ne,e.interval))}let ye=0,Se=0,A=0,Ce=0,le=!1,_e=!1;function Be(t){var n;if(Ie||!(!((n=v.value)===null||n===void 0)&&n.contains(Ut(t))))return;Ie=!0,le=!0,_e=!1,Ce=Date.now(),se(),t.type!=="touchstart"&&!t.target.isContentEditable&&t.preventDefault();const s=Ze(t)?t.touches[0]:t;S.value?Se=s.clientY:ye=s.clientX,e.touchable&&(W("touchmove",document,re,{passive:!0}),W("touchend",document,L),W("touchcancel",document,L)),e.draggable&&(W("mousemove",document,re),W("mouseup",document,L))}function re(t){const{value:n}=S,{value:s}=C,i=Ze(t)?t.touches[0]:t,u=n?i.clientY-Se:i.clientX-ye,l=P.value[s];A=ce(u,-l,l),t.cancelable&&t.preventDefault(),f.value&&oe(M-A,0)}function L(){const{value:t}=N;let n=t;if(!V&&A!==0&&f.value){const s=M-A,i=[...$.value.slice(0,D.value-1),Ae()];let u=null;for(let l=0;l<i.length;l++){const g=Math.abs(i[l]-s);if(u!==null&&u<g)break;u=g,n=l}}if(n===t){const s=Date.now()-Ce,{value:i}=C,u=P.value[i];A>u/2||A/s>.4?n=ee(t):(A<-u/2||A/s<-.4)&&(n=te(t))}n!==null&&n!==t?(_e=!0,Y(n),Oe(()=>{(!b.value||ge.value!==E.value)&&U(pe.value)})):U(pe.value),Fe(),O()}function Fe(){le&&(Ie=!1),le=!1,ye=0,Se=0,A=0,Ce=0,Z("touchmove",document,re),Z("touchend",document,L),Z("touchcancel",document,L),Z("mousemove",document,re),Z("mouseup",document,L)}function vt(){if(f.value&&V){const{value:t}=N;be(t,0)}else O();f.value&&(we.value.transitionDuration="0ms"),V=!1}function ht(t){if(t.preventDefault(),V)return;let{deltaX:n,deltaY:s}=t;t.shiftKey&&!n&&(n=s);const i=-1,u=1,l=(n||s)>0?u:i;let g=0,w=0;S.value?w=l:g=l;const k=10;(w*s>=k||g*n>=k)&&(l===u&&!Te()?ne():l===i&&!Ve()&&me())}function pt(){P.value=qe(r.value,!0),O()}function gt(){var t,n;_.value&&((n=(t=z.effect).scheduler)===null||n===void 0||n.call(t),z.effect.run())}function xt(){e.autoplay&&se()}function mt(){e.autoplay&&O()}Je(()=>{Ft(O),requestAnimationFrame(()=>K.value=!0)}),Qe(()=>{Fe(),se()}),Mt(()=>{const{value:t}=m,{value:n}=x,s=new Map,i=l=>s.has(l)?s.get(l):-1;let u=!1;for(let l=0;l<t.length;l++){const g=n.findIndex(w=>w.el===t[l]);g!==l&&(u=!0),s.set(t[l],g)}u&&t.sort((l,g)=>i(l)-i(g))}),ue(N,(t,n)=>{if(t!==n)if(O(),f.value){if(b.value&&Q.value>2){const{value:s}=D;t===s-2&&n===1?t=0:t===1&&n===s-2&&(t=s-1)}be(t,pe.value)}else U()},{immediate:!0}),ue([b,B],()=>void Oe(()=>Y(N.value))),ue($,()=>f.value&&U(),{deep:!0}),ue(f,t=>{t?U():(V=!1,oe(M=0))});const wt=h(()=>({onTouchstartPassive:e.touchable?Be:void 0,onMousedown:e.draggable?Be:void 0,onWheel:e.mousewheel?ht:void 0})),bt=h(()=>Object.assign(Object.assign({},je(H,["to","prev","next","isPrevDisabled","isNextDisabled"])),{total:Q.value,currentIndex:E.value})),yt=h(()=>({total:Q.value,currentIndex:E.value,to:H.to})),St={getCurrentIndex:()=>E.value,to:xe,prev:me,next:ne},Ct=et("Carousel","-carousel",dn,jt,e,a),Me=h(()=>{const{common:{cubicBezierEaseInOut:t},self:{dotSize:n,dotColor:s,dotColorActive:i,dotColorFocus:u,dotLineWidth:l,dotLineWidthActive:g,arrowColor:w}}=Ct.value;return{"--n-bezier":t,"--n-dot-color":s,"--n-dot-color-focus":u,"--n-dot-color-active":i,"--n-dot-size":n,"--n-dot-line-width":l,"--n-dot-line-width-active":g,"--n-arrow-color":w}}),X=o?Ot("carousel",void 0,Me,e):void 0;return Object.assign(Object.assign({mergedClsPrefix:a,selfElRef:r,slidesElRef:v,slideVNodes:x,duplicatedable:b,userWantsControl:R,autoSlideSize:_,displayIndex:E,realIndex:N,slideStyles:Ee,translateStyle:we,slidesControlListeners:wt,handleTransitionEnd:vt,handleResize:pt,handleSlideResize:gt,handleMouseenter:xt,handleMouseleave:mt,isActive:lt,arrowSlotProps:bt,dotSlotProps:yt},St),{cssVars:o?void 0:Me,themeClass:X==null?void 0:X.themeClass,onRender:X==null?void 0:X.onRender})},render(){var e;const{mergedClsPrefix:a,showArrow:o,userWantsControl:r,slideStyles:v,dotType:m,dotPlacement:x,slidesControlListeners:S,transitionProps:C={},arrowSlotProps:p,dotSlotProps:f,$slots:{default:b,dots:R,arrow:B}}=this,F=b&&Lt(b())||[];let _=pn(F);return _.length||(_=F.map(P=>y(cn,null,{default:()=>Ge(P)}))),this.duplicatedable&&(_=Gt(_)),this.slideVNodes.value=_,this.autoSlideSize&&(_=_.map(P=>y(Le,{onResize:this.handleSlideResize},{default:()=>P}))),(e=this.onRender)===null||e===void 0||e.call(this),y("div",Object.assign({ref:"selfElRef",class:[this.themeClass,`${a}-carousel`,this.direction==="vertical"&&`${a}-carousel--vertical`,this.showArrow&&`${a}-carousel--show-arrow`,`${a}-carousel--${x}`,`${a}-carousel--${this.direction}`,`${a}-carousel--${this.effect}`,r&&`${a}-carousel--usercontrol`],style:this.cssVars},S,{onMouseenter:this.handleMouseenter,onMouseleave:this.handleMouseleave}),y(Le,{onResize:this.handleResize},{default:()=>y("div",{ref:"slidesElRef",class:`${a}-carousel__slides`,role:"listbox",style:this.translateStyle,onTransitionend:this.handleTransitionEnd},r?_.map((P,z)=>y("div",{style:v[z],key:z},Xt(y(Yt,Object.assign({},C),{default:()=>P}),[[Kt,this.isActive(z)]]))):_)}),this.showDots&&f.total>1&&Xe(R,f,()=>[y(an,{key:m+x,total:f.total,currentIndex:f.currentIndex,dotType:m,trigger:this.trigger,keyboard:this.keyboard})]),o&&Xe(B,p,()=>[y(rn,null)]))}});function pn(e){return e.reduce((a,o)=>(un(o)&&a.push(o),a),[])}const gn=ve("\u5F00\u59CB"),xn=Ht("h3",null,"Help:",-1),mn=ve("\u70B9\u51FB\u201C\u5F00\u59CB\u201D\u6309\u94AE\u5F00\u59CB\u5168\u5C4F\u68C0\u6D4B"),wn=ve("\u4F7F\u7528\u2190\u3001\u2192\u65B9\u5411\u952E\u63A7\u5236\u663E\u793A\u989C\u8272"),bn=ve("\u70B9\u51FBesc\u952E\u53EF\u9000\u51FA\u5168\u5C4F"),Cn=J({setup(e){let a=I(null),o=I(0);I(!1);const r=["#FAFAFC","red","blue","green","white","#777777","black","linear-gradient(#e66465, #9198e5)",`linear-gradient(217deg, rgba(255,0,0,.8), rgba(255,0,0,0) 70.71%),
            linear-gradient(127deg, rgba(0,255,0,.8), rgba(0,255,0,0) 70.71%),
            linear-gradient(336deg, rgba(0,0,255,.8), rgba(0,0,255,0) 70.71%)`],v=h(()=>r.map(x=>({width:"100vw",height:"100vh",background:x})));_t({passive:!1,reactive:!0,onEventFired(x){x.type=="keyup"&&(x.key=="ArrowLeft"&&(o.value--,o.value<0&&(o.value+=r.length)),x.key=="ArrowRight"&&(o.value++,o.value=o.value%r.length))}});const m=async()=>{const{enter:x,isFullscreen:S}=Rt(a);await x()};return(x,S)=>{const C=Ke("n-button"),p=Ke("n-li");return Re(),Pe(Ye,null,[q(ze(hn),{ref_key:"el",ref:a,id:"screen-tester","show-arrow":!1,"show-dots":!1,"current-index":ze(o)},{default:G(()=>[(Re(!0),Pe(Ye,null,Wt(ze(v),f=>(Re(),Pe("div",{style:tt(f)},null,4))),256))]),_:1},8,["current-index"]),q(C,{onClick:m},{default:G(()=>[gn]),_:1}),xn,q(p,null,{default:G(()=>[mn]),_:1}),q(p,null,{default:G(()=>[wn]),_:1}),q(p,null,{default:G(()=>[bn]),_:1})],64)}}});export{Cn as default};
